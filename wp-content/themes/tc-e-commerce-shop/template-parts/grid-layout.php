        ...
        <div class="postbox">           
            ...
            <div class="new-text">
                <div class="box-content">
                    ...
                    <p><?php the_excerpt(); ?></p>
                    <?php the_tags(); ?>
                    <a href="<?php  get_permalink() ;?>" class="blogbutton-small hvr-sweep-to-right" title="<?php esc_attr_e( 'Read Full', 'tc-e-commerce-shop' ); ?>"><?php esc_html_e('Read Full','tc-e-commerce-shop'); ?></a>
                </div>
            </div>
