					...
					<div class="container inner-table">
						<div class="inner-table-cell">
							<div class="caption verticle-center text-center wow zoomIn">
								...
								<?php echo $content; ?>
								<?php if( get_post_meta(get_the_ID(),'magzee_slidebutton', true ) ): ?>
								<a href="<?php echo esc_url( get_post_meta( get_the_ID(),'magzee_slidebutton', true) ); ?>" class="specia-btn-1">
									<?php echo esc_html_e( 'Read More','magzee' ); ?> 
								</a>
								<?php
									endif;
								?>
